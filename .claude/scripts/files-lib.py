...
# (Backlog der Template-Pflege, Q4), das als duenne Fassade (Re-Export dieser drei Module) plus dem
...
# ---------------------------------------------------------------------------
# Schutz vor Datenverlust beim Entfernen (Backlog #30, Backlog der Template-Pflege)
# ---------------------------------------------------------------------------
#
...
# exakter Zeilenabgleich statt einer eigenen Pfadliste wie TEMPLATE_ONLY_PATHS. Aktuell leer - kein Marker
# mehr noetig, eine Sitzung im Template-Root verhaelt sich immer wie ein frischer Klon. Liste bleibt bewusst
# als Mechanismus stehen (remove_welcome_gitignore_lines() bleibt aufrufbar, wird nur zum No-op), falls ein
# kuenftiger Template-only-Hinweis in .gitignore denselben Weg braucht.
