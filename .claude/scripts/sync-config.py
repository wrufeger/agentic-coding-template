...
#
# Zusaetzlich (Backlog B37, Backlog der Template-Pflege): AI-CONFIG.md steht in keep_local und wird beim
...
def _ai_config_key_diffs(cp, tu, root: Path, hinweise: list, ref: str = None, fetch: bool = True) -> list:
    """Backlog B37 (Backlog der Template-Pflege): Schluessel, die die Template-Fassung von AI-CONFIG.md kennt,
