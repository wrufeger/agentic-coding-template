...
# -*- coding: utf-8 -*-
#
# Zweck: In einem frisch geklonten Template-Checkout (B51, docs/ai/backlog.md) bekommt das Modell zu
...
#
#        Erkennung frischer Klon: eine Sitzung im Root-Ordner verhaelt sich immer wie ein frischer Klon,
#        unabhaengig davon, ob hier auch am Template selbst gearbeitet wird - die Weiterentwicklung des
#        Templates laeuft in einem eigenen, separaten Pflege-Repo, nicht in diesem Checkout.
...
Die Weiterentwicklung des Templates laeuft in einem eigenen, separaten Pflege-Repo, nicht in diesem \
Checkout.
...
def _ist_frischer_klon(root: Path) -> bool:
    """True nur bei is_template:true - eine Sitzung im Root-Ordner verhaelt sich immer wie ein frischer Klon.
    Jeder Lesefehler/jede unerwartete Form -> False, also kein Kontext - im Zweifel nichts ausgeben."""
    try:
