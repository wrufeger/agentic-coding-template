...
Übersicht des Arbeitsordners: `../README.md`.
...
Der Stand unten wird von `python .templatedev/scripts/test-projects.py --update` geschrieben; `--check`
vergleicht ihn mit dem, was in den Projekten tatsächlich liegt, ohne etwas zu ändern.
...
`coding_rules.md` § „Kreislauf eines Befunds".
...
**und** hier — bzw. in `../ai/` dieses Projekts — als Befund verbucht, wenn die Ursache im Template liegt.
