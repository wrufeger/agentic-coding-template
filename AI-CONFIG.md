...
| Orchestrator |  |  | `ORCHESTRATOR` | Rufname des Haupt-Assistenten. Leer = Kurzname des Werkzeugs, das die Einrichtung ausführt (Claude Code → Fable, Gemini CLI → Gemini, …); wird keines erkannt, gilt „Fable“. |
